...
public class CandidateValidator implements Predicate<Candidate> {
    ...
    private static final int INDEX_OF_YEAR_ENTERING_UKRAINE = 0;
    private static final int INDEX_OF_LAST_YEAR_STAYING_IN_UKRAINE = 1;
    ...
    public boolean test(Candidate candidate) {
        ...
        int inUkraineTill =
                Integer.parseInt(inUkraineFromAndTill[INDEX_OF_LAST_YEAR_STAYING_IN_UKRAINE]);
