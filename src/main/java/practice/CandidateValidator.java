...
public class CandidateValidator implements Predicate<Candidate> {
    ...
    public boolean test(Candidate o) {
        if (o.getAge() >= MIN_AGE_PRESIDENT
            ...
            String[] years = o.getPeriodsInUkr().split(SEPARATOR);
            return (Integer.parseInt(years[INDEX_BIG_DATE])
                    - Integer.parseInt(years[INDEX_SMALL_DATE])) > MIN_YEAR_LIVE_IN_UKRAINE;
        }
        return false;
    }
}
