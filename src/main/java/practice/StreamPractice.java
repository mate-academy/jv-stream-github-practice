...
public class StreamPractice {
    private static final String FIND_MIN_EXCEPTION = "Can't get min value from list - %s";
    private static final String NO_SUCH_ELEMENT_AVERAGE = "There is no average value";
    ...
    public int findMinEvenNumber(List<String> numbers) {
        return numbers
            ...
            .orElseThrow(() -> new RuntimeException(String.format(FIND_MIN_EXCEPTION, numbers)));
    }
    ...
    public Double getOddNumsAverage(List<Integer> numbers) {
        return IntStream
            ...
            .average()
            .orElseThrow(() -> new NoSuchElementException(NO_SUCH_ELEMENT_AVERAGE));
    }
