...
public class StreamPractice {
    ...
    public List<Person> selectMenByAge(List<Person> peopleList, int fromAge, int toAge) {
        Predicate<Person> isManByAge = new Predicate<Person>() {
            @Override
    ...
    public List<Person> getWorkablePeople(int fromAge, int femaleToAge,
        ...
        Predicate<Person> isWorkable = new Predicate<Person>() {
            @Override
            public boolean test(Person p) {
                int toAge = p.getSex() == Person.Sex.WOMAN ? femaleToAge : maleToAge;
    ...
    public List<String> getCatsNames(List<Person> peopleList, int femaleAge) {
        Predicate<Person> isWomanByAge = new Predicate<Person>() {
            @Override
            public boolean test(Person p) {
