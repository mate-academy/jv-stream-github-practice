...
public class StreamPractice {
    ...
    public List<Person> getWorkablePeople(int fromAge, int femaleToAge,
        ...
        Predicate<Person> workablePerson = person -> {
            boolean passFromAge = person.getAge() >= fromAge;
            boolean passToAge;
            if (person.getSex() == Person.Sex.MAN) {
                passToAge = person.getAge() <= maleToAge;
            } else {
                passToAge = person.getAge() <= femaleToAge;
            }
            return passFromAge && passToAge;
        };
