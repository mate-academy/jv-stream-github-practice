...
public class StreamPractice {
    ...
    public List<Person> selectMenByAge(List<Person> peopleList, int fromAge, int toAge) {
        return peopleList.stream().filter(obj ->
                obj.getSex().toString().equals("MAN")
                        && obj.getAge() >= fromAge
                        && obj.getAge() <= toAge).collect(Collectors.toList());
    }
    ...
    public List<Person> getWorkablePeople(int fromAge, int femaleToAge,
        ...
        Predicate<Person> predicate = (person -> person.getAge() >= fromAge
                && ((person.getSex().toString().equals("MAN")
    ...
    public List<String> getCatsNames(List<Person> peopleList, int femaleAge) {
        return peopleList.stream().filter(person -> !person.getCats().isEmpty()
                ...
                .flatMap(objCat -> objCat.getCats().stream())
                .map(Cat::getName)
                .collect(Collectors.toList());
    }
