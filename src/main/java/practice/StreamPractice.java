...
public class StreamPractice {
    ...
    public List<Person> selectMenByAge(List<Person> peopleList, int fromAge, int toAge) {
        Predicate<Person> testMenByAge = (person) ->
    ...
    public List<Person> getWorkablePeople(int fromAge, int femaleToAge,
        ...
        Predicate<Person> testWorkablePeople = person ->
                person.getAge() >= fromAge && person.getAge()
                        <= (person.getSex() == Person.Sex.WOMAN ? femaleToAge : maleToAge);
        return peopleList
                .stream()
                .filter(testWorkablePeople)
                .collect(Collectors.toList());
    }
