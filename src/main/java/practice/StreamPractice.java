...
public class StreamPractice {
    ...
    public Double getOddNumsAverage(List<Integer> numbers) {
        return IntStream.range(0, numbers.size())
                ...
                .filter(a -> a % 2 != 0)
                .average()
                .orElseThrow(() -> new NoSuchElementException("sorry there's no such data"));
    }
     ...
     * which has following view: "2002-2015" 2002 2015
