...
public class StreamPractice {
    ...
    public int findMinEvenNumber(List<String> numbers) {
        return numbers.stream()
                ...
                .filter(num -> num % 2 == 0)
                .min()
                .orElseThrow(() -> new RuntimeException(NO_MIN_VALUE_MESSAGE + numbers));
    }
    ...
    public List<People> selectMenByAge(List<People> peopleList, int fromAge, int toAge) {
        Predicate<People> isSuitableMenByAge = person -> person.getSex() == People.Sex.MAN
                && person.getAge() >= fromAge
                && person.getAge() <= toAge;
        return peopleList.stream()
                .filter(isSuitableMenByAge)
    ...
    public List<People> getWorkablePeople(int fromAge, int femaleToAge,
        ...
        Predicate<People> isWorkablePerson = person -> person.getSex() == People.Sex.MAN
