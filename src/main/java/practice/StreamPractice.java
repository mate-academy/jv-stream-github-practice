...
public class StreamPractice {
    private static final String DIVIDE_STRING_NUMBER = ",";
    private static final int MINIMUM_WORKING_AGE = 18;
    private static final int MAXIMUM_WORKING_AGE_FOR_MEN = 60;
    private static final int MAXIMUM_WORKING_AGE_FOR_WOMEN = 55;
    /**
    ...
    public int findMinEvenNumber(List<String> numbers) {
        List<Integer> numbersList = numbers.stream()
                .flatMap(s -> Arrays.stream(s.split(DIVIDE_STRING_NUMBER)))
    ...
    public List<Person> getWorkablePeople(int fromAge, int femaleToAge,
        ...
        Predicate<Person> customPredicate = new Predicate<Person>() {
            @Override
