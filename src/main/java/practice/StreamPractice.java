...
public class StreamPractice {
    ...
    public Double getOddNumsAverage(List<Integer> numbers) {
        ...
        OptionalDouble oddNumsAverage = modifiedNumbers.stream()
                .filter(num -> num % 2 == 1)
                .mapToInt(Integer::intValue)
                .average();
        return oddNumsAverage.orElseThrow(NoSuchElementException::new);
    }
    ...
    public List<Person> selectMenByAge(List<Person> peopleList, int fromAge, int toAge) {
        return peopleList.stream()
                ...
                .filter(human -> human.getAge() >= fromAge && human.getAge() <= toAge)
    ...
    public List<Person> getWorkablePeople(int fromAge, int femaleToAge,
        ...
        return peopleList.stream()
                .filter(person -> {
                    ...
                    } else if (person.getSex().equals(Person.Sex.WOMAN)) {
