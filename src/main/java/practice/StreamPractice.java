...
public class StreamPractice {
    ...
    public List<Person> selectMenByAge(List<Person> peopleList, int fromAge, int toAge) {
        Predicate<Person> agePredicate = person -> person.getAge() >= fromAge
                && person.getAge() <= toAge;
        Predicate<Person> sexPredicate = person -> person.getSex() == Person.Sex.MAN;
        return peopleList.stream()
                .filter(sexPredicate.and(agePredicate))
