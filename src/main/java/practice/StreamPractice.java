...
public class StreamPractice {
    private static final Person.Sex MALE_SEX_VALUE = Person.Sex.MAN;
    private static final Person.Sex FEMALE_SEX_VALUE = Person.Sex.WOMAN;
    /**
    ...
    public List<Person> selectMenByAge(List<Person> peopleList, int fromAge, int toAge) {
        Predicate<Person> personPredicate = new Predicate<Person>() {
            ...
            public boolean test(Person person) {
                return person.getSex() == MALE_SEX_VALUE
        ...
        Predicate<Person> personPredicate = new Predicate<Person>() {
            ...
            public boolean test(Person person) {
                return person.getSex() == MALE_SEX_VALUE
                        ...
                        || person.getSex() == FEMALE_SEX_VALUE
                        && person.getAge() >= fromAge
    ...
    public List<String> getCatsNames(List<Person> peopleList, int femaleAge) {
        Predicate<Person> personPredicate = new Predicate<Person>() {
            @Override
            public boolean test(Person person) {
                return person.getSex() == FEMALE_SEX_VALUE
