...
public class StreamPractice {
     ...
     *
     * <p>Example: select men who can be recruited to army (from 18 to 27 years old inclusively).
     */
     ...
     *
     * <p>Example: select people of working age (from 18 y.o. and to 60 y.o. for men and to 55 y.o.
     * for women inclusively).
     */
    ...
    public List<String> getCatsNames(List<Person> peopleList, int femaleAge) {
        return peopleList.stream()
                ...
                .flatMap(c -> c.getCats().stream().map(s -> s.getName()))
                .collect(Collectors.toList());
    }
