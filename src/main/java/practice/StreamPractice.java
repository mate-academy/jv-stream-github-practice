...
public class StreamPractice {
    ...
    public Double getOddNumsAverage(List<Integer> numbers) {
        return IntStream.range(0, numbers.size())
                ...
                .mapToDouble(o -> o)
                .average()
                .orElseThrow(() -> new NoSuchElementException("Numbers hasn't odd"));
    }
    ...
    public List<Person> selectMenByAge(List<Person> peopleList, int fromAge, int toAge) {
        return peopleList.stream()
                .filter(p -> fromAge <= p.getAge() && p.getAge() <= toAge && p.getSex().equals(Person.Sex.MAN))
    ...
    public List<Person> getWorkablePeople(int fromAge, int femaleToAge,
        ...
        return peopleList.stream()
                .filter(p -> fromAge <= p.getAge() && (p.getAge() <= maleToAge && p.getSex().equals(Person.Sex.MAN)
