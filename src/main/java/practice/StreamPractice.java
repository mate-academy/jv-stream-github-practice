...
public class StreamPractice {
    ...
    public int findMinEvenNumber(List<String> numbers) {
        String cantGetMinException = String.format(
        ...
        return numbers
                ...
                .orElseThrow(() -> new RuntimeException(cantGetMinException));
    }
    ...
    public List<Person> selectMenByAge(List<Person> peopleList, int fromAge, int toAge) {
        ...
        return peopleList
                .stream()
                .filter(new ManByAge(fromAge, toAge))
    ...
    public List<Person> getWorkablePeople(int fromAge, int femaleToAge,
        ...
        class PeopleByAge implements Predicate<Person> {
            ...
            @Override
            public boolean test(Person person) {
                int toAge = person.getSex().equals(Person.Sex.MAN)
        ...
        return peopleList
                .stream()
                .filter(new PeopleByAge(fromAge, femaleToAge, maleToAge))
                .collect(Collectors.toList());
    }
