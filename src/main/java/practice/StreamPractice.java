...
public class StreamPractice {
    ...
    public List<People> selectMenByAge(List<People> peopleList, int fromAge, int toAge) {
        return peopleList
                ...
                .filter(e -> e.getAge() >= fromAge
                        && e.getAge() <= toAge && e.getSex().equals(People.Sex.MAN))
    ...
    public List<People> getWorkablePeople(int fromAge, int femaleToAge,
        ...
        return peopleList
                .stream()
                .filter(e -> e.getAge() >= fromAge
                        && ((e.getSex() == People.Sex.MAN && e.getAge() <= maleToAge)
                        || (e.getSex() == People.Sex.WOMEN && e.getAge() <= femaleToAge)))
                .collect(Collectors.toList());
    }
    ...
    public List<String> getCatsNames(List<People> peopleList, int femaleAge) {
        return peopleList
                .stream()
                .filter(e -> e.getSex() == People.Sex.WOMEN && e.getAge() >= femaleAge)
